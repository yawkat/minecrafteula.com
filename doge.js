...
var doges = ["unwow", "such eula", "many bad", "very destroy minceraft servurs", "pls dont harass mojang",
             "#blameMojang", "so thought through", "many destroy lifes", "very credit card steal",
             "wow", "so bad exp", "greetins from #xorfans", "such open-src site", "many change",
             "such operashun balkout", "very unwow", "(end user license agree)", "very cosmetic stuff only",
             "many destroy networkes", "so market change", "many remove perks", "unwow"];
